...
/**
 * class FormAdmin3 héritée de la classe Form
 * Génère le formulaire de la page admin3.php pour la modification de  billet
 */
class FormAdminModified extends Form {
